...
import {
  Shield, Zap, Search, Globe, AlertTriangle, Lock,
    ...
    <div className="container py-4">
      ...
      <div className="hero-section text-center mb-4">
        ...
        <p className="text-muted mx-auto" style={{ maxWidth: 500 }}>
          Detect XSS, SQL Injection, CSRF, Nmap port scans, and more — powered by Vultix AI.
        </p>
      ...
      {recentScans.length > 0 && (
        <section className="mb-5">
          <div className="d-flex align-items-center justify-content-between mb-3">
            ...
            <a href="/history" className="vx-link small d-flex align-items-center gap-1">
          ...
          <div className="row g-3">
            {recentScans.map(scan => (
              <div className="col-md-6 col-lg-4" key={scan.id}>
                <div className="glass-card scan-card p-3" onClick={() => navigate(`/scan/${scan.id}`)}>
